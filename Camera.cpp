...
void CCamera::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	//XMFLOAT4X4 xmf4x4identityView;
	//xmf4x4identityView = Matrix4x4::Identity();
	////XMStoreFloat4x4(&xmf4x4View, XMMatrixTranspose(XMLoadFloat4x4(&m_xmf4x4View)));
	//::memcpy(&m_pcbMappedCamera->m_xmf4x4identityView, &xmf4x4identityView, sizeof(XMFLOAT4X4));
	...
	XMStoreFloat4x4(&m_pcbMappedCamera->m_xmf4x4identityView, XMMatrixTranspose(XMMatrixMultiply(XMLoadFloat4x4(&m_xmf4x4View), XMLoadFloat4x4(&m_xmf4x4Projection))));
